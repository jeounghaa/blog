...
urlpatterns = [
    ...
    url(r'^post/(?P[-\w]+)/$', PostDV.as_view(), name='post_detail'),

    # Example: /archive/
    url(r'^archive/$', PostAV.as_view(), name='post_archive'),

    # Example: /2012/
    url(r'^(?P\d{4})/$', PostYAV.as_view(), name='post_year_archive'),

    # Example: /2012/nov/
    url(r'^(?P\d{4})/(?P[a-z]{3})/$', PostMAV.as_view(), name='post_month_archive'),

    # Example: /2012/nov/10/
    url(r'^(?P\d{4})/(?P[a-z]{3})/(?P\d{1,2})/$', PostDAV.as_view(), name='post_day_archive'),
